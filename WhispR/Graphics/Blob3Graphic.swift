...
struct Blob3Graphic: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1))]), startPoint: .top, endPoint: .bottom).ignoresSafeArea()
            ...
            LinearGradient(
                ...
                .offset(x: 60, y: 240)
                .blur(radius: 50)
            Stars(hasScrolled: $hasScrolled).offset(x: -100, y: -200)
            Stars(hasScrolled: $hasScrolled).offset(y: -400)
            Stars(hasScrolled: $hasScrolled).offset(y: 0)
            LinearGradient(
                gradient: Gradient(stops: [
                                    .init(color: Color(#colorLiteral(red: 0.1764705926, green: 0.01176470611, blue: 0.5607843399, alpha: 1)), location: 0),
                                    .init(color: Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)), location: 0.48761284351348877),
...
struct Blob3Graphic_Previews: PreviewProvider {
    static var previews: some View {
        Blob3Graphic(hasScrolled: .constant(false))
...
//            .offset(x: 60, y: 100)
//            .blur(radius: 50)
//        Stars(hasScrolled: .constant(false)).offset(y: -200)
//        LinearGradient(
//            gradient: Gradient(stops: [
//                                .init(color: Color(#colorLiteral(red: 0.1764705926, green: 0.01176470611, blue: 0.5607843399, alpha: 1)), location: 0),
