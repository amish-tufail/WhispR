...
//  DesignCodeUniversal
//
//  Created by Meng To on 2021-04-07.
//
    ...
    var body: some View {
        ZStack {
            LinearGradient(
                ...
                .overlay(
                    Stars(hasScrolled: .constant(false)).opacity(0)
                )
                .mask(Facemask())
...
struct Star: View {
    ...
    var body: some View {
        Circle().fill(hasScrolled ? Color.cyan : Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)))
            .frame(width: 3.4, height: 3.4)
            .offset(x: 200, y: 0)
            .shadow(color: hasScrolled ? Color.cyan : Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)), radius:2, x:0, y:0)
        .opacity(0.6)
    }
}
...
struct Star3: View {
    ...
    var body: some View {
        Circle().fill(hasScrolled ? Color.cyan : Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)))
            ...
            .offset(x: 0, y: 0)
        .shadow(color: hasScrolled ? Color.cyan : Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)), radius:1, x:0, y:0)
        .opacity(0.9)
    }
}
